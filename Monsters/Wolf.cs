...
namespace DungeonExplorer
{
    ...
    internal class Wolf : Monster
    {
        ...
        public Wolf() : base("Wolf", 30, 20, 40, 10, 20)
        {
        }
        ...
        public override string Damage()
        {
            ...
            return $"You hit the {Name} as hard as you could, dealing {damageDealt} damage. Whimpering, it cowers backwards, growling, and now has {Health} health.";
        }
    }
}